clear
./waf --run "test --BeaconInterval=102400 --pagePeriod=3 --pageSliceLength=1 --pageSliceCount=3 --simulationTime=30 --payloadSize=64 --rho=100 --TrafficType=\"coap\" --PrintStats=true --RAWConfigFile=\"./OptimalRawGroup/RawConfig-10-3-1-102400-0-31.txt\"  --TrafficInterval=5000 --CycleTime=512 --nControlLoops=1 --DataMode=\"MCS2_8\" --seed=1 --EnableVirtualAids=false" -j4
